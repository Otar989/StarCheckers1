                ...
                <div className="space-y-3">
                  ...
                  {onlineStep === "none" && (
                    <button
                      ...
                      onMouseLeave={() => setHoveredButton(null)}
                      className="w-full flex items-center gap-3 h-12 px-4 rounded-2xl bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 border border-white/20 transition-all duration-300 hover:scale-105 hover:from-emerald-500/30 hover:to-cyan-500/30 text-white hover:shadow-lg"
                    >
                      <Wifi className="w-5 h-5" />
                      <span className="font-medium">Играть онлайн</span>
                    </button>
                  )}
